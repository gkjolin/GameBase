...
/// 铁甲兵
/// </summary>
public class IronSoldier : GeneralSoldier
{
    ...
    ///// 状态列表
    ///// </summary>
    //public GeneralIdleState _idleState;//待机状态
    ////public GeneralFindState _findState;//锁敌状态
    ...
    //public GeneralWinState _winState;//胜利状态
    ...
    //        if (eventId == WalkToEnemyState.EVENT_BLOCK)
    //        {
    //            setState(_findEnemyState);
    //            return true;
    //        }

    //        if (eventId == WalkToEnemyState.EVENT_FAIL)
    //        {
    //            setState(_findEnemyState);
    //            return true;
    //        }
